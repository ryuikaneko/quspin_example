...
#    basis_1d = spin_basis_1d(L=N,m=m,S="1/2",pauli=0)
    basis_1d = spin_basis_1d(L=N,m=m,S="1/2",pauli=0,kblock=k,pblock=p)
#    basis_1d = spin_basis_1d(L=N,m=m,S="1/2",pauli=0,a=1,kblock=k)
#    basis_1d = spin_basis_1d(L=N,m=m,S="1/2",pauli=0,a=1,kblock=k,pblock=p)
#    basis_1d = spin_basis_1d(L=N,m=m,S="1/2",pauli=0,a=1,kblock=k,pblock=p)
#    basis_1d = spin_basis_1d(L=N,m=0,S="1/2",pauli=0,a=1,kblock=0,pblock=1,zblock=1)
