...
#    L = 4 # length of chain
    ...
    Jleg3 = 0.25 # spin-spin interaction, leg3
    Jleg4 = 0.25 # spin-spin interaction, leg4
#    Jleg3 = 0.10 # spin-spin interaction, leg3
#    Jleg4 = 0.10 # spin-spin interaction, leg4
    Jrung = 1.0 # spin-spin interaction, rung
    Dleg1 = 1.0 # Ising anisotropy, leg1
    Dleg2 = 1.0 # Ising anisotropy, leg2
    Dleg3 = 1.0 # Ising anisotropy, leg3
    Dleg4 = 1.0 # Ising anisotropy, leg4
...
## search all momenta
        ...
        if intm == 2*L:
            k = 0
            p = +1
            ene = exact_diag(Jleg1,Jleg2,Jleg3,Jleg4,Jrung,Dleg1,Dleg2,Dleg3,Dleg4,Drung,L,m,k,p)
            list_tmp_ene.append(ene[0])
            print("#",2*L,Jleg1,Jleg2,Jleg3,Jleg4,Jrung,intm,m,k,p,ene[0])
        else:
...
#----
        ...
        print(2*L,Jleg1,Jleg2,Jleg3,Jleg4,Jrung,intm,m,ene)
